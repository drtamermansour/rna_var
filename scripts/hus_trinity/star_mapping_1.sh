...
#!/bin/sh -login
#PBS -l nodes=1:ppn=8,mem=32gb,walltime=4:00:00
...
cd ${genome_path}/STAR_mapping_1
STAR --genomeDir ${genome_path}/new_index --readFilesIn ${data_path}/SRR1153470_1.fastq ${data_path}/SRR1153470_2.fastq  --runThreadN 7
