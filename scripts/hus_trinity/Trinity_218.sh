...
Trinity --seqType fq --max_memory 60G --no_path_merging --left ${data_path}/SRR1258218_1.fastq --right ${data_path}/SRR1258218_1.fastq --output ${out_path}/trinity_out_218 --CPU 6
