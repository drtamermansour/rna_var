...
#!/bin/sh -login
#PBS -l nodes=1:ppn=2,mem=64gb,walltime=16:00:00
...
java -Xmx10g -cp $GATK -jar $GATK/GenomeAnalysisTK.jar -T HaplotypeCaller -R ${genome_path}/GATK_indexed/build37_corID.fa -I ${out_path}/GATK_out/split.bam -dontUseSoftClippedBases -stand_call_conf 20.0 -o ${out_path}/GATK_out/output.vcf -bamout ${out_path}/GATK_out/bamout.bam
